...
function ScannerOverlay({ detected }: { detected: boolean }) {
  ...
  return (
    <View pointerEvents="none" style={{ flex: 1 }}>
      ...
      <Text style={{ position: "absolute", top: top + FRAME_SIZE + 24, alignSelf: "center", color: theme.colors.textSecondary, fontFamily: theme.fonts.display, fontSize: 13, letterSpacing: 1 }}>
    ...
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      <Pressable
        ...
        style={({ pressed }) => ({
          position: "absolute",
          alignSelf: "center",
          bottom: Math.max(insets.bottom, 20) + 82,
          flexDirection: "row",
          alignItems: "center",
          gap: 8,
